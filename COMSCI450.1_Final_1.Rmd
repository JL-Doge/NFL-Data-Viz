...
quantile(Finaldive$Point.Spread.Rating.QB)
summary(Finaldive$Point.Spread.Rating.QB)
plot(Finaldive$Point.Spread.Rating.QB)

team <-  read.csv("./data_2/FinalDF_ONLY32teams.csv")
plot(team$Point.Spread.Rating.QB)

ordered <- team[order(team$Point.Spread.Rating.QB) ,]
...
Revisiting Model selection (4-21-22)
```{r}
library(leaps)
#regfit.full1 = regsubsets(Made.Playoffs~., Finaldive, really.big=T)
#summary(regfit.full1)
#don't run this. Try running it with 8 variables
```
...
Finaldive3 = Finaldive[c(2,3,6, 45,52, 57, 4, 73, 69,  75)]

sum(is.na(Finaldive3))


regfit.full1 = regsubsets(Made.Playoffs~., Finaldive3)
summary(regfit.full1)
...
plot(reg.summary1$adjr2, xlab = "Number of Variables", ylab = "Adjusted RSq", type = "l")
points(6, reg.summary1$adjr2[6], col = "red", cex = 2, pch = 20)

which.min(reg.summary1$cp)
#6

plot(reg.summary1$cp, xlab = "Number of Variables", ylab = "Cp",
type = "l")
points(6, reg.summary1$cp[6], col = "red", cex = 2, pch = 20)

plot(reg.summary1$bic, xlab = "Number of Variables", ylab = "BIC", type = "l")
points(6, reg.summary1$bic[6], col = "red", cex = 2, pch = 20)
...
```{r}
regfit.full2 = regsubsets(Made.Playoffs~., data = Finaldive3, nvmax = 9)
